        ...
        <div class="context">
            <ul class="neirong">
                <c:forEach items="${bookList}" var="book">
                    <li>
                        <div class="tupian"><a
                                href="${pageContext.request.contextPath}/novelPage?bookId=${book.bookId}"><img
                                src="${book.bookDetail.picAddress}" alt=""></a></div>
                        <div class="wenzi">
                            <h5>${book.bookName}</h5>
                ...
                <c:forEach items="${randList}" var="bookRand">
                    <li>
                        <div class="tupian"><a
                                ...
                                src="${bookRand.bookDetail.picAddress}" alt=""></a></div>
                        <div class="wenzi">
